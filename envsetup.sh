...
eula_check() {
    ...
    local machine_file=$(find ${ROOTOE}/ -type d \( -name '.git' -o -name '.repo' -o -name 'build*' -o -name 'source*' -o -name 'script*' \) -prune -o -type f -name "$MACHINE.conf" | grep "/machine/$MACHINE.conf")
...
conf_bblayerconf()
{
    local _MACH_CONF=$(find ${ROOTOE}/ -type d \( -name '.git' -o -name '.repo' -o -name 'build*' -o -name 'source*' -o -name 'script*' \) -prune -o -type f -name "$MACHINE.conf" | grep "/machine/$MACHINE.conf")
...
EOF
        ...
        echo "[WARNING] Not able to find ${MACHINE}.conf file in ${ROOTOE} : bblayer.conf not updated..."
    fi
}
